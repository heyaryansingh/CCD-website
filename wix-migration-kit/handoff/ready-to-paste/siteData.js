...
export const pages = {
  ...
  cards: [
  { title: "Members join", meta: "Learn more: Members join", body: "Residents, businesses, nonprofits, and supporters pay dues that fund the shared work.", href: "/what-is-a-coop" },
  { title: "Members govern", meta: "Learn more: Members govern", body: "One member gets one vote. Big decisions come back to the people closest to the work.", href: "/what-is-a-coop" },
  { title: "Members share benefits", meta: "Learn more: Members share benefits", body: "Tool access, service discounts, markets, events, and neighborhood improvements stay local.", href: "/membership" },
  ],
  },
  ...
  cards: [
  { title: "Shop local", meta: "Learn more: Shop local", body: "Support neighborhood makers, growers, and food vendors every market day.", href: "/events" },
  { title: "Become a vendor", meta: "Learn more: Become a vendor", body: "Local vendors can register to sell at upcoming markets.", href: actionLink(siteConfig.links.vendorRegistration, "Co-op Market vendor registration", siteConfig.contact.facilitiesEmail) },
  { title: "Bring the family", meta: "Learn more: Bring the family", body: "Music, food, and learning for all ages. Contact Marquita for details.", href: mailtoFallback("Co-op Market", siteConfig.contact.facilitiesEmail) },
  ],
  },
  {
  type: "gallery",
